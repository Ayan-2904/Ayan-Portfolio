...
const Skills = () => {
  const skillsList = ['Angular', 'JavaScript', 'TypeScript', 'Python', 'SQL', 'Node.js', 'Nest.js', 'Express.js', 'React.js', 'Tailwind CSS', 'MongoDB', 'MySQL', 'PostgreSQL', 'UI/UX Design', 'Figma', 'AWS', 'Docker', 'Git'];
